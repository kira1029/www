...
class ControllerProductProduct extends Controller {
	...
	public function index() {
		...
		if ($product_info) {
            ...
            if (!isset($result)||$result['state_information'] == 'n') {
			$data['add'] = $this->url->link('account/address/add', '', 'SSL');
            } else {
            	# code...
	        $data['add'] = $this->url->link('account/address', '', 'SSL');
            }
	...
	// public function valicontact(){
	// 	$this->load->model('account/address');
 //            $results = $this->model_account_address->getAddresses();
 //            foreach ($results as $result){
 //            }
 //        if ($result['state_contact'] == 'n') {
	// 		$this->error['warning'] = $this->language->get('text_contact');
	// 	}
